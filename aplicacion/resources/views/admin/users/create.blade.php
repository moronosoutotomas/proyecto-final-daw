		...
		<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
			...
			<nav class="mb-8">
				<ol class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
					...
					<li><span class="mx-2">/</span></li>
					<li class="text-gray-900 dark:text-white">Novo usuario</li>
				</ol>
			</nav>
			...
			<div
				...
				<div class="px-6 py-8">
					<div class="mb-8">
						<h1 class="text-3xl font-bold text-gray-900 dark:text-white">Novo usuario</h1>
						<p class="mt-2 text-gray-600 dark:text-gray-400">Engade un novo usuario</p>
					</div>
