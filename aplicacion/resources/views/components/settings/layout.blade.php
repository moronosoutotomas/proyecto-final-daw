...
>
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
		<div class="flex gap-4 md:gap-8 max-md:flex-col">
			<!-- sidebar -->
			...
			<main class="flex-1 min-w-0">
				<div
					class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 md:p-8">
					<div class="mb-6">
