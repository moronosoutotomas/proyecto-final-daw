...
<x-settings.layout heading="Apariencia" subheading="Personaliza cómo se ve la aplicación">
    <form wire:submit="updateTheme" class="space-y-6">
        <div>
            ...
            <div class="space-y-3">
                <!-- Opción Light -->
                <label class="flex items-center p-4 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors {{ $theme === 'light' ? 'bg-amber-50 border-amber-500 dark:bg-amber-900/20 dark:border-amber-500' : '' }}">
                    <input type="radio" 
                           wire:model.live="theme" 
                           value="light" 
                           class="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 dark:border-gray-600">
                    <div class="ml-3 flex items-center">
                        <svg class="h-5 w-5 text-gray-700 dark:text-gray-300 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Opción Dark -->
                <label class="flex items-center p-4 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors {{ $theme === 'dark' ? 'bg-amber-50 border-amber-500 dark:bg-amber-900/20 dark:border-amber-500' : '' }}">
                    <input type="radio" 
                           wire:model.live="theme" 
                           value="dark" 
                           class="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 dark:border-gray-600">
                ...
                <!-- Opción System -->
                <label class="flex items-center p-4 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors {{ $theme === 'system' ? 'bg-amber-50 border-amber-500 dark:bg-amber-900/20 dark:border-amber-500' : '' }}">
                    <input type="radio" 
                           wire:model.live="theme" 
                           value="system" 
                           class="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 dark:border-gray-600">
