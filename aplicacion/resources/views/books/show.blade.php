                            ...
                            @can('reviews.create')
                                <div id="reviewForm" class="hidden mb-8 p-6 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    ...
                                    <form action="{{ route('reviews.store') }}" method="POST">
                                        ...
                                        <div class="mb-4">
                                            <label for="rating"
                                                   class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Valoración</label>
                                        ...
                                        <div class="mb-4">
                                            <label for="content"
                                                   class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Comentario</label>
                            ...
                            <div class="space-y-4">
                                @forelse($book->reviews as $review)
                                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                        <div class="flex justify-between items-start mb-2">
                                            <div class="flex items-center">
                                                <div
                                                    class="w-8 h-8 bg-amber-600 rounded-full flex items-center justify-center text-white text-sm font-medium">
                                                ...
                                                <div class="ml-3">
                                                    ...
                                                    <div class="flex text-amber-400">
                                                        @for($i = 1; $i <= 5; $i++)
                                                            <svg
                                                                class="w-4 h-4 {{ $i <= $review->rating ? 'fill-current' : 'text-gray-300 dark:text-gray-600' }}"
                                                                viewBox="0 0 20 20">
                                                                <path
                                                                    d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                                            </svg>
                                ...
                                @empty
                                    <div class="text-center py-8">
                                        ...
                                        <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">Non hay
                                            reseñas</h3>
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Sé o primeiro en
                                            escribir unha reseña.</p>
                                    </div>
                                @endforelse
                            </div>
                        </div>
