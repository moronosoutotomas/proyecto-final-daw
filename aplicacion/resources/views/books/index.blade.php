                                        ...
                                        @if($book->avg_rating)
                                            <div class="flex items-center">
                                                <div class="flex text-amber-400">
                                                    @for($i = 1; $i <= 5; $i++)
                                                        <svg class="w-4 h-4 {{ $i <= $book->avg_rating ? 'fill-current' : 'text-gray-300 dark:text-gray-600' }}" viewBox="0 0 20 20">
                                                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                                        </svg>
                                                    @endfor
                                                </div>
                                                <span class="ml-1 text-sm text-gray-500 dark:text-gray-400">{{ $book->avg_rating }}</span>
                                            </div>
                                        @else
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center">
                                        <div class="text-gray-500 dark:text-gray-400">
                                            ...
                                            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">Non hai libros</h3>
                                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Engade o teu primeiro libro.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
